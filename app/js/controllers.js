...
shoppingCartControllers.controller('HomeCtrl', ['$scope', 'Product', function ($scope, Product) {
  $scope.products = Product.query();
  $scope.orderProp = 'price';
}]);

shoppingCartControllers.controller('ProductCtrl', ['$scope', '$routeParams', 'Product',
  function($scope, $routeParams, Product) {
    ...
    $scope.addToCart = function (tempQuantity) {
      ...
      $scope.status_msg = "Added to cart :)";
...
shoppingCartControllers.controller('CartCtrl', ['$scope', 'Product', function ($scope, Product) {
  $scope.cart = [];
  $scope.quantity = window.quantity;
